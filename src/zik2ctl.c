...
static const Zik2Api zik2_api[] = {
  { "API_AUDIO_TRACK_METADATA_URI", API_AUDIO_TRACK_METADATA_URI },
  { "API_AUDIO_NOISE_CONTROL_ENABLED_URI", API_AUDIO_NOISE_CONTROL_ENABLED_URI },
  { "API_AUDIO_NOISE_CONTROL_URI", API_AUDIO_NOISE_CONTROL_URI },
  { "API_AUDIO_NOISE_CONTROL_PHONE_MODE_URI", API_AUDIO_NOISE_CONTROL_PHONE_MODE_URI },
  { "API_AUDIO_NOISE_CANCELLATION_ENABLE_URI", API_AUDIO_NOISE_CANCELLATION_ENABLE_URI },
  { "API_AUDIO_THUMB_EQUALIZER_VALUE_URI", API_AUDIO_THUMB_EQUALIZER_VALUE_URI },
  { "API_AUDIO_EQUALIZED_ENABLED_URI", API_AUDIO_EQUALIZED_ENABLED_URI },
  { "API_AUDIO_SMART_AUDIO_TUNE_URI", API_AUDIO_SMART_AUDIO_TUNE_URI },
  { "API_AUDIO_PRESET_BYPASS_URI", API_AUDIO_PRESET_BYPASS_URI },
  { "API_AUDIO_PRESET_CURRENT_URI", API_AUDIO_PRESET_CURRENT_URI },
  { "API_AUDIO_SOUND_EFFECT_ENABLED_URI", API_AUDIO_SOUND_EFFECT_ENABLED_URI },
  { "API_AUDIO_SOUND_EFFECT_URI", API_AUDIO_SOUND_EFFECT_URI },
  { "API_AUDIO_NOISE_URI", API_AUDIO_NOISE_URI },
  { "API_AUDIO_VOLUME_URI", API_AUDIO_VOLUME_URI },
  { "API_AUDIO_SOURCE_URI", API_AUDIO_SOURCE_URI },
  { "API_SOFTWARE_VERSION_URI", API_SOFTWARE_VERSION_URI },
  { "API_BLUETOOTH_FRIENDLY_NAME_URI", API_BLUETOOTH_FRIENDLY_NAME_URI },
  { "API_SYSTEM_BATTERY_URI", API_SYSTEM_BATTERY_URI },
  { "API_SYSTEM_BATTERY_FORECAST_URI", API_SYSTEM_BATTERY_FORECAST_URI },
  { "API_SYSTEM_AUTO_CONNECTION_ENABLED_URI", API_SYSTEM_AUTO_CONNECTION_ENABLED_URI },
  { "API_SYSTEM_ANC_PHONE_MODE_ENABLED_URI", API_SYSTEM_ANC_PHONE_MODE_ENABLED_URI },
  { "API_SYSTEM_DEVICE_TYPE_URI", API_SYSTEM_DEVICE_TYPE_URI },
  { "API_SYSTEM_COLOR_URI", API_SYSTEM_COLOR_URI },
  { "API_SYSTEM_PI_URI", API_SYSTEM_PI_URI },
  { "API_SYSTEM_HEAD_DETECTION_ENABLED_URI", API_SYSTEM_HEAD_DETECTION_ENABLED_URI },
  { "API_SYSTEM_FLIGHT_MODE_URI", API_SYSTEM_FLIGHT_MODE_URI },
  { NULL, NULL },
};
